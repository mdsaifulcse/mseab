...
class ProductCartController extends Controller
{
    ...
    public function add_to_cart(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            ...
            return $this->respondWithSuccess('Product added to cart', [],Response::HTTP_OK);
        }
    ...
    public static function remove_cart_item(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            ...
            return response()->json([
                'success'=>true,
                'message'=>'Product Successfully Remove From Product Cart',
                'date'=>$all_cart_items,'code'=>Response::HTTP_OK
            ],
                Response::HTTP_OK
            );
        }
    ...
    public function ajax_cart_update(Request $request){
        ...
        if ($request->wantsJson()) {
            ...
            return response()->json([
                'success'=>true,
                'message'=>'Product Cart Successfully Update',
                'date'=>$all_cart_items,'code'=>Response::HTTP_OK
            ],
                Response::HTTP_OK
            );
