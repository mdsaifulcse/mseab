...
class FrontendUserManageController extends Controller
{
    ...
    public function userPaymentDetails($id){
        $user_payments = FeeCollection::where('user_id',$id)->get();
        return view('backend.frontend-user.user-payment-details',compact('user_payments'));
    }
}
