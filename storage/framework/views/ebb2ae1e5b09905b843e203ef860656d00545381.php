        ...
        <div class="menu-inner">
            <nav id="main_menu_wrap">
                <ul class="metismenu" id="menu">
                    ...
                    <?php if(check_page_permission_by_string('admin_manage')): ?>
                    <li
                        class="main_dropdown <?php echo e(active_menu('admin-home/fee-collection/all-fee-collection')); ?>

                        <?php echo e(active_menu('admin-home/fee-collection/all-fee-collection')); ?>

                        "
                    >
                        <a href="javascript:void(0)" aria-expanded="true"><i class="ti-money"></i>
                            <span><?php echo e(__('Fee Collection')); ?></span></a>
                        <ul class="collapse">
                            <li class="<?php echo e(active_menu('admin-home/fee-collection/all-fee-collection')); ?>"><a
                                    href="<?php echo e(route('admin-home.fee-collection.all-fee-collection')); ?>"><?php echo e(__('All Fee Collection')); ?></a></li>
                        </ul>
                    </li>
                    <?php endif; ?>
                    ...
                    <?php if(check_page_permission_by_string('admin_manage')): ?>
                    <li
                        class="main_dropdown <?php echo e(active_menu('admin-home/community/all-post')); ?>

                        <?php echo e(active_menu('admin-home/community/all-post')); ?>

                        "
                    >
                        <a href="javascript:void(0)" aria-expanded="true"><i class="ti-money"></i>
                            <span><?php echo e(__('Community')); ?></span></a>
                        <ul class="collapse">
                            <li class="<?php echo e(active_menu('admin-home/community/all-post')); ?>"><a
                                    href="<?php echo e(route('admin-home.community.all-post')); ?>"><?php echo e(__('All Post')); ?></a></li>
                        </ul>
                    </li>
                    <?php endif; ?>
                    ...
                    <?php endif; ?>
                    <?php if(check_page_permission_by_string('notification')): ?>
                    <li class="main_dropdown <?php echo e(active_menu('admin-home/notification')); ?>">
                        <a href="<?php echo e(url('admin-home/notification')); ?>" aria-expanded="true"><i class="ti-control-forward"></i>
                            <span><?php echo e(__('Notice')); ?></span></a>
                    </li>
                    <?php endif; ?>
...
<?php /**PATH /home/aapbd/public_html/dohs/resources/views/backend/partials/sidebar.blade.php ENDPATH**/ ?>