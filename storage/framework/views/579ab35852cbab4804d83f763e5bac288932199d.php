                ...
                <form method="POST" action="<?php echo e(route('admin.login')); ?>">
                    ...
                    <div class="login-form-body">
                        ...
                        <div class="submit-btn-area">
                            <button id="login_form_submit" type="submit"><?php echo e(__('Login')); ?> <i class="ti-arrow-right"></i></button>
                        </div>
                    </div>
                </form>
            </div>
...
<?php echo $__env->make('layouts.login-screens', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aapbd/public_html/dohs/resources/views/auth/admin/login.blade.php ENDPATH**/ ?>