                        ...
                        <div class="col-12 mt-5">
                            <div class="card">
                                ...
                                <!-- Modal -->
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="title" value="{{old('title')}}" class="form-control"  id="title" placeholder="{{__('Enter title')}}" required>
                                                        @if ($errors->has('title'))
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="description" class="form-control" rows="6" placeholder="{{__('Enter Description')}}">{{old('description')}}</textarea>
                                    ...
                                    <h4 class="header-title">{{__('All Notice')}} <a href="#" data-toggle="modal" data-target="#myModal" style="float: right;margin-bottom: 10px;" class="btn btn-primary"><i class="fa fa-plus"></i> Add New Notice </a></h4>
                                            ...
                                            @forelse($notices as $key=>$notice)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="myModal{{$notice->id}}" data-toggle="modal" data-target="#myModal{{$notice->id}}" class="btn btn-lg btn-warning btn-sm mb-3 mr-1"><i class="ti-pencil"></i></a>
                                                       ...
                                                       <h6>{{__('Are you sure to delete this Notice?')}}</h6>
                                                       <form method='post' action='{{route('notification.destroy',$notice->id)}}'>
                                                ...
                                                <div id="myModal{{$notice->id}}" class="modal fade" role="dialog">
                                                    <div class="modal-dialog">
                                                        ...
                                                        <form action="{{route('notification.update',$notice->id) }}" method="post"  enctype="multipart/form-data">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="title">{{__('Title')}}</label>
                                                                        <input type="text" name="title" value="{{old('title',$notice->title)}}" class="form-control"  id="title" placeholder="{{__('Enter title')}}" required>
                                                                        @if ($errors->has('title'))
                                                                            <span class="help-block text-danger">
                                                                <strong>{{ $errors->first('title') }}</strong>
                                                            </span>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea name="description" class="form-control" rows="6" placeholder="{{__('Enter Description')}}">{{old('description',$notice->description)}}</textarea>
