        ...
        <div class="menu-inner">
            <nav id="main_menu_wrap">
                <ul class="metismenu" id="menu">
                    ...
                    @if(check_page_permission_by_string('admin_manage'))
                    <li
                        class="main_dropdown {{active_menu('admin-home/fee-collection/all-fee-collection')}}
                        {{active_menu('admin-home/fee-collection/all-fee-collection')}}
                        "
                    >
                        <a href="javascript:void(0)" aria-expanded="true"><i class="ti-money"></i>
                            <span>{{__('Fee Collection')}}</span></a>
                        <ul class="collapse">
                            <li class="{{active_menu('admin-home/fee-collection/all-fee-collection')}}"><a
                                    href="{{route('admin-home.fee-collection.all-fee-collection')}}">{{__('All Fee Collection')}}</a></li>
                        </ul>
                    </li>
                    @endif
                    ...
                    @if(check_page_permission_by_string('admin_manage'))
                    <li
                        class="main_dropdown {{active_menu('admin-home/community/all-post')}}
                        {{active_menu('admin-home/community/all-post')}}
                        "
                    >
                        <a href="javascript:void(0)" aria-expanded="true"><i class="ti-money"></i>
                            <span>{{__('Community')}}</span></a>
                        <ul class="collapse">
                            <li class="{{active_menu('admin-home/community/all-post')}}"><a
                                    href="{{route('admin-home.community.all-post')}}">{{__('All Post')}}</a></li>
                        </ul>
                    </li>
                    @endif
                    ...
                    @endif
                    @if(check_page_permission_by_string('notification'))
                    <li class="main_dropdown {{active_menu('admin-home/notification')}}">
                        <a href="{{url('admin-home/notification')}}" aria-expanded="true"><i class="ti-control-forward"></i>
                            <span>{{__('Notice')}}</span></a>
                    </li>
                    @endif
