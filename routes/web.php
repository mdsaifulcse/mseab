...
//frontend Fee Collection manage
Route::prefix('admin-home')->middleware(['admin_manage_check'])->group(function (){
    //user role management
    Route::get('/fee-collection/all-fee-collection','FeeCollectionController@getAllFeeCollectionData')->name('admin-home.fee-collection.all-fee-collection');

    Route::get('/community/all-post','PostController@index')->name('admin-home.community.all-post');
    Route::post('/community/all-post/delete','PostController@deleteOPost')->name('admin-home.community.all-post.delete');
...
Route::prefix('admin-home')->middleware(['users_manage_check'])->group(function (){
    ...
    Route::get('/user-payment-details/{id}','FrontendUserManageController@userPaymentDetails');
});
